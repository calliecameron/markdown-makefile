...
class TestInclude(unittest.TestCase):
    ...
    def test_include(self) -> None:
        ...
        doc1 = test_utils.pandoc_lua_filter(PANDOC, FILTER, DOC1)
        ...
        doc2 = test_utils.pandoc_lua_filter(PANDOC, FILTER, DOC2 % doc1_file)
        ...
        doc2_inc = test_utils.pandoc_lua_filter(PANDOC, FILTER, DOC2_INC % doc1_file)
    ...
    def test_include_fails(self) -> None:
        ...
        with self.assertRaises(ValueError):
            test_utils.pandoc_lua_filter(PANDOC, FILTER, DOC2 % bad_file)
