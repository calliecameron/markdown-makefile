...
class TestBaseMetadata(unittest.TestCase):
    ...
    def test_get_version(self) -> None:
        ...
        self.assertEqual(core.base_metadata.get_version(base, {
            'a': clean,
            'b': dirty_same_repo,
        ...
        self.assertEqual(core.base_metadata.get_version(
    ...
    def test_get_metadata(self) -> None:
        self.assertEqual(core.base_metadata.get_metadata('foo', 'bar', False), {
            'docversion': 'foo',
            'subject': 'Version: foo',
            'lang': 'en-GB',
            'repo': 'bar',
        ...
        self.assertEqual(core.base_metadata.get_metadata('foo', 'bar', True), {
            'docversion': 'foo',
            'subject': 'Version: foo',
            'lang': 'en-GB',
            'repo': 'bar',
    ...
    def run_script(self, raw_version: Dict[str, str], deps_versions: List[Dict[str, str]],
        ...
        return (self.load_file(dep_versions_out_file),
    ...
    def test_main_complex(self) -> None:
        dep_versions_out, metadata_out = self.run_script(
            {'docversion': 'foo', 'repo': 'bar', 'pandoc_version': '1'},
            [{'docversion': '2, dirty', 'repo': 'bar'},
             {'docversion': '3', 'repo': 'quux'}],
