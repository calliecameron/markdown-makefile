...
import markdown.core.base_metadata
...
class TestBaseMetadata(unittest.TestCase):
    def test_version(self) -> None:
        v = markdown.core.base_metadata.Version.from_dict(
    ...
    def test_get_version(self) -> None:
        base = markdown.core.base_metadata.Version("1", "foo")
        clean = markdown.core.base_metadata.Version("2", "bar")
        dirty = markdown.core.base_metadata.Version("3-dirty", "baz")
        unversioned = markdown.core.base_metadata.Version("unversioned", "quux")
        dirty_same_repo = markdown.core.base_metadata.Version("4-dirty", "foo")
        unversioned_same_repo = markdown.core.base_metadata.Version("unversioned", "foo")

        self.assertEqual(
            markdown.core.base_metadata.get_version(base, {}, "").version,
            "1",
        )
        self.assertEqual(markdown.core.base_metadata.get_version(base, {}, "").repo, "foo")
        self.assertEqual(
            markdown.core.base_metadata.get_version(base, {"a": clean}, "").version,
            "1",
        )
        self.assertEqual(
            markdown.core.base_metadata.get_version(base, {"a": clean}, "").repo,
            "foo",
        )
        self.assertEqual(
            markdown.core.base_metadata.get_version(
                base,
        ...
        with self.assertRaises(ValueError):
            markdown.core.base_metadata.get_version(base, {"a": dirty}, "")
        with self.assertRaises(ValueError):
            markdown.core.base_metadata.get_version(base, {"a": unversioned}, "")

        self.assertEqual(
            markdown.core.base_metadata.get_version(base, {}, "OVERRIDE").version,
            "OVERRIDE",
        )
        self.assertEqual(
            markdown.core.base_metadata.get_version(base, {}, "OVERRIDE").repo,
            "foo",
        )
        self.assertEqual(
            markdown.core.base_metadata.get_version(
        ...
        self.assertEqual(
            markdown.core.base_metadata.get_version(base, {"a": clean}, "OVERRIDE").repo,
            "foo",
        )
        self.assertEqual(
            markdown.core.base_metadata.get_version(
        ...
        with self.assertRaises(ValueError):
            markdown.core.base_metadata.get_version(base, {"a": dirty}, "OVERRIDE")
        with self.assertRaises(ValueError):
            markdown.core.base_metadata.get_version(base, {"a": unversioned}, "OVERRIDE")

    def test_get_metadata(self) -> None:
        self.assertEqual(
            markdown.core.base_metadata.get_metadata("foo", "bar", False),
            {
                "docversion": "foo",
                "subject": "Version: foo",
                "lang": "en-GB",
        ...
        self.assertEqual(
            markdown.core.base_metadata.get_metadata("foo", "bar", True),
            {
                "docversion": "foo",
                "subject": "Version: foo",
                "lang": "en-GB",
