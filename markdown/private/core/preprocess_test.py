...
from markdown.private.core import preprocess
...
class TestPreprocess(test_utils.ScriptTestCase):
    def test_process_include(self) -> None:
        ...
        # No include
        line, used, problem = preprocess.process_include(
            "foo bar",
            deps,
            "foo",
        )
    ...
    def test_process_images(self) -> None:
        ...
        # No images
        line, used, problems = preprocess.process_images(
    ...
    def test_preprocess(self) -> None:
        ...
        problems = preprocess.preprocess(data, deps, images, "a")
        self.assertEqual(problems, [])
