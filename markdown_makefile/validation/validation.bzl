...
def _py_validation():
    py_test(
        ...
        args = [
            ...
            "--scripts-are-modules",
            "$(locations //markdown_makefile/collection:py_srcs)",
            "$(locations //markdown_makefile/core:py_srcs)",
            "$(locations //markdown_makefile/formats:py_srcs)",
            "$(locations //markdown_makefile/group:py_srcs)",
        ...
        data = [
            "//:mypy.ini",
            "//markdown_makefile/collection:py_srcs",
            "//markdown_makefile/core:py_srcs",
            "//markdown_makefile/formats:py_srcs",
            "//markdown_makefile/group:py_srcs",
...
def _sh_validation(name = None):  # buildifier: disable=unused-variable
    native.sh_test(
        ...
        data = [
            ...
            "//markdown_makefile/collection:sh_srcs",
            "//markdown_makefile/formats:sh_srcs",
            "//markdown_makefile/git:sh_srcs",
            "//markdown_makefile/group:sh_srcs",
