...
class TestInclude(unittest.TestCase):
    def test_include(self) -> None:
        ...
        doc1 = markdown_makefile.utils.test_utils.pandoc_lua_filter(PANDOC, FILTER, DOC1)
        self.assertEqual(
            doc1,
            {
                "blocks": [
    ...
    def test_include_fails(self) -> None:
        ...
        with self.assertRaises(ValueError):
            markdown_makefile.utils.test_utils.pandoc_lua_filter(PANDOC, FILTER, DOC2 % bad_file)
